      ...
      Papa.parse(file, {
        ...
        complete: (results) => {
          ...
          if (results.errors.length > 0) {
            setError(
              'Error parsing the CSV file. Please make sure it is valid.'
            );
          } else {
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          {!csvData && (
            <div className="mt-5">
              ...
              >
                {loading ? (
                  <span className="font-plus-jakarta-sans text-lg">
                    Loading...
                  </span>
                ) : selectedFile ? (
                  <>
                  ...
                  <>
                    <div className="flex flex-col py-10 justify-center items-center font-plus-jakarta-sans">
                      ...
                      <span className="text-description font-[700px] text-hidden font-plus-jakarta-sans">
                ...
                {csvData.map((row, rowIndex) => (
                  <tr key={rowIndex}>
                    {Object.values(row).map((cell, cellIndex) => (
                      <td
                        key={cellIndex}
                        className="  border border-slate-700  text-center rounded"
                      >
                        {cell}
                      </td>
                    ))}
